...
public class Student {
	...
	public Student(long prn, String firstName, String lastName, LocalDate dateOfBirth, String gender, String email,
			long phone, YearMonth joiningMonthAndYear, String city, float tenthMarks, float twelthMarks,
			float diplomaMarks, float graduationMarks, float postGraduationMarks, int workExperience, String password) {
		super();
		this.prn = prn;
	...
	public String toString() {
		return "Student [prn=" + prn + ", firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth="
				...
				+ workExperience + ", password=" + password + "]";
	}
}
